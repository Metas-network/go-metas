Please check if what you want to add to `go-metas` list meets [quality standards](https://github.com/Metas-network/go-metas/blob/master/CONTRIBUTING.md#quality-standard) before sending pull request.
