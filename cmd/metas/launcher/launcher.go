...
import (
	...
	"github.com/Metas-network/go-metas/cmd/metas/launcher/metrics"
	"github.com/Metas-network/go-metas/cmd/metas/launcher/tracing"
	"github.com/Metas-network/go-metas/debug"
	"github.com/Metas-network/go-metas/flags"
	"github.com/Metas-network/go-metas/gossip"
	"github.com/Metas-network/go-metas/integration"
	"github.com/Metas-network/go-metas/utils/errlock"
	"github.com/Metas-network/go-metas/valkeystore"
	_ "github.com/Metas-network/go-metas/version"
)

const (
	// clientIdentifier to advertise over the network.
	clientIdentifier = "go-metas"
)
...
var (
	...
	app = flags.NewApp(gitCommit, gitDate, "the go-metas command line interface")
...
func initFlags() {
	...
	nodeFlags = append(nodeFlags, metasFlags...)
...
// metas is the main entry point into the system if no special subcommand is ran.
...
func startNode(ctx *cli.Context, stack *node.Node) {
	...
	// Create a client to interact with local metas node.
