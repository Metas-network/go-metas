...
import (
	...
	"github.com/Metas-network/lachesis-base/abft"
	"github.com/Metas-network/lachesis-base/hash"
	"github.com/Metas-network/lachesis-base/utils/cachescale"
	...
	"github.com/Metas-network/go-metas/evmcore"
	"github.com/Metas-network/go-metas/gossip"
	"github.com/Metas-network/go-metas/gossip/gasprice"
	"github.com/Metas-network/go-metas/integration"
	"github.com/Metas-network/go-metas/integration/makegenesis"
	"github.com/Metas-network/go-metas/metas"
	"github.com/Metas-network/go-metas/metas/genesisstore"
	futils "github.com/Metas-network/go-metas/utils"
	"github.com/Metas-network/go-metas/vecmt"
)
...
var (
	...
	AllowedOperaGenesisHashes = map[uint64]hash.Hash{
		metas.MainNetworkID: hash.HexToHash("0x4a53c5445584b3bfc20dbfb2ec18ae20037c716f3ba2d9e1da768a9deca17cb4"),
		metas.TestNetworkID: hash.HexToHash("0xc4a5fc96e575a16a9a0c7349d44dc4d0f602a54e0a8543360c2fee4c3937b49e"),
	}
)
